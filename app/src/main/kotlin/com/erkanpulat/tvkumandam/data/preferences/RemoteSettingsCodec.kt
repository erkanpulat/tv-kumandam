...
/**
 * String fields escape every non-safe UTF-16 code unit as `^HHHH`, keeping delimiters structural.
 * The parser rejects incomplete, duplicate, oversized, malformed and unsupported schemas.
 */
