...
4. Var olan üretim uygulamasını kaldırmadan, APK'yı `adb install -r app/build/outputs/apk/debug/app-debug.apk` ile yükleyin. Telefon yüklemeyi engellerse USB hata ayıklama/kurulum iznini telefondan onaylayın.
